...
// clang-format off
    ...
    #define ATTRIBUTE_ALIGNED128(a)  a __attribute__((aligned(128)))
		...
		// We should keep BT_USE_SSE_IN_API the same among all source
		// To ensure Structure Return Convention consistent when we return btVector3
        #define BT_USE_SSE_IN_API
        // BT_USE_SSE_IN_API is enabled by default, because memory is automatically aligned on 16-byte boundaries by our custom allocator
        #include <immintrin.h>
